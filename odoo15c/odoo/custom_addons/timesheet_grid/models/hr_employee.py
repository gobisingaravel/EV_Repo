...
class Employee(models.Model):
    ...
    def get_timesheet_and_working_hours_for_employees(self, employees_grid_data, date_start, date_stop):
        ...
        # employee_ids = [employee_data.get('employee_id') for employee_data in employees_grid_data]
        employee_ids = []
        for employee_data in employees_grid_data:
            if employee_data.get('employee_id'):
                employee_ids.append(employee_data.get('employee_id'))
